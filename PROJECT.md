...
> Version: `1.3.0` | Stack: FastAPI · SQLAlchemy · MySQL · Vanilla JS · HTML/CSS
...
| Dashboard         | `/dashboard`      | Admin stats overview + recent users                  |
...
| Incident Reports  | `/reports`        | *(v1.3.0)* Super Admin report viewer & management   |
...
*Documentation last updated: August 23, 2026 — v1.3.0*
